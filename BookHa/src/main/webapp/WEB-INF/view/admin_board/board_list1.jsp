...
<body>
				...
				<ul class="menu-inner py-1">
					...
					<li class="menu-item" style=""><a href="javascript:void(0)"
						...
						<ul class="menu-sub">
							...
							<li class="menu-item"><a href="/업적과순위.do" class="menu-link">
									<div data-i18n="Alerts">업적과 순위</div>
							</a></li>
							<li class="menu-item"><a href="/찔끔챌린지.do" class="menu-link">
						...
						<ul class="navbar-nav flex-row align-items-center ms-auto">
							...
							<li class="nav-item navbar-dropdown dropdown-user dropdown">
								...
								<ul class="dropdown-menu dropdown-menu-end">
									<li><a class="dropdown-item" href="#">
											<div class="d-flex">
												...
												<div class="flex-grow-1">
													<span class="fw-semibold d-block">Manager</span> <small
									...
									<li><a class="dropdown-item" href="./admin_main.do"> <i
									...
									<tbody class="table-border-bottom-0">
										<tr>
											<td><i class="fab fa-angular fa-lg text-danger me-2"></i>
												<a href="./admin_view.do" style="color: gray"> <strong>[필독]&nbsp;&nbsp;</strong>게시판
	...
	<div class="buy-now">
		<a href="./admin_write.do" class="btn btn-outline-primary btn-buy-now">글
			작성하기</a>
	</div>
