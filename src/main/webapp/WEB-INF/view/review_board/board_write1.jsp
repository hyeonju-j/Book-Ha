...
<body>
										...
										<tr>
											<td>&nbsp;&nbsp;
												<button type="button" class="btn rounded-pill btn-outline-primary">#
													소설</button> &nbsp;
												<button type="button"
													class="btn rounded-pill btn-outline-primary" name="btnradio"># 수필</button>
												&nbsp;
												<button type="button"
													class="btn rounded-pill btn-outline-primary" name="btnradio"># 시</button>
												&nbsp;
												<button type="button"
													class="btn rounded-pill btn-outline-primary" name="btnradio"># 인문/사회</button> &nbsp;
												<button type="button"
													class="btn rounded-pill btn-outline-primary" name="btnradio"># 과학</button>
												&nbsp;
												<button type="button"
													class="btn rounded-pill btn-outline-primary" name="btnradio"># 기타</button>
											</td>
										</tr>
									</tbody>
								</table>
	...
	<div class="buy-now">
		<a
			...
			target="_blank" class="btn btn-outline-primary btn-buy-now">작성 완료</a>
	</div>
